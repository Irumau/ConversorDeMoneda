...
//		try {
//			URL url = new URL(
//					" https://api.getgeoapi.com/v2/currency/historical/2018-10-12?api_key=02d64c36ab1702f7c2a39d8001dea0017409f3ae");
//			HttpURLConnection conn = (HttpURLConnection) url.openConnection();
//			conn.setRequestMethod("GET");
//			conn.connect();
//			int responseCode = conn.getResponseCode();
...
//				JSONObject jsonObject = new JSONObject(informationString.toString());
//
//				String jsontest = jsonObject.getString("base_currency_code");
//
